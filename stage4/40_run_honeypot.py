    ...
    cases = [
        ...
        {"name": "expert_10_skills_zero", "profile": {"years_of_experience": 6.0},
         ...
         "skills": [{"name": f"S{i}", "proficiency": "expert", "duration_months": 0}
                    for i in range(10)]},
        {"name": "skill_longer_than_career", "profile": {"years_of_experience": 4.0},
         "career_history": [{"company": "X", "title": "Eng", "start_date": "2021-01-01",
                             "end_date": "2025-01-01", "duration_months": 48}],
         "skills": [{"name": "Py", "proficiency": "expert", "duration_months": 120}]},
